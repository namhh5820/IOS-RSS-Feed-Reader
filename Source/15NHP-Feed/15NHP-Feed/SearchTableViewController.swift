...
class SearchTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        let query = "SELECT * FROM " + Session.s_table + " WHERE TITLE LIKE '%"  + Session.s_keyword + "%'"
        ...
        if arrtitle.count == 0  {
            ...
            let alertController = UIAlertController(title: "Result", message: "Keyword not found!!!", preferredStyle: .alert)
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.textLabel?.font =  cell.textLabel?.font.withSize(CGFloat(Session.s_fontSize))
