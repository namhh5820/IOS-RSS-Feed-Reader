...
class AllTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        let query = "SELECT * FROM " + Session.s_table + " ORDER BY ID DESC"
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "all_cell", for: indexPath) as! AllTableViewCell
